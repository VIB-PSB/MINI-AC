...
workflow MINIAC {
    ...
    if (params.mode == "genome_wide" && params.species == "maize") {
    ...
    if (params.mode == "genome_wide" && params.species == "maize_v5") {
    ...
    else if (params.mode == "locus_based" && params.species == "maize") {
        ...
        exit 1, "MINI-AC can only be run using the modes 'genome_wide' and 'locus_based', and with the species 'arabidopsis', 'maize' and 'maize_v5'. Instead it got '${params.species}' and '${params.mode}' "
        }
}
